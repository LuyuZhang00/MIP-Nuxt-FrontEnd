        ...
        <div class="header-wrapper">
          ...
          <div>
            ...
            <div class="sub-title" v-if="patientList.length > 0">
              <div class="block"></div>选择就诊卡： <span class="card-tips"><span class="iconfont"> </span>
            ...
            <div class="content-wrapper">
              <el-form ref="form">
                ...
                <el-form-item label="医生职称：">
                  <div class="content"><span>{{ schedule.title }} </span>
                  </div>
                </el-form-item>
