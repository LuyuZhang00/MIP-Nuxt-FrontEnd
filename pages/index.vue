        ...
        <div class="home-filter-wrapper">
          ...
          <div>
            <div class="filter-wrapper">
              ...
              <div class="condition-wrapper"><span class="item v-link highlight clickable selected">全部 </span>
              ...
              <div class="hospital-list-item hos-item" index="0">
                <div class="wrapper">
                  ...
                  <div class="bottom-container">
                    ...
                    <div class="icon-wrapper"><span class="iconfont"> </span>每天 8:30 放号</div>
                  </div>
                </div>
            ...
            <div class="">
              <div class="hospital-list-item hos-item" index="0">
                <div class="wrapper">
                  ...
                  <div class="bottom-container">
                    <div class="icon-wrapper"><span class="iconfont"> </span>三级甲等
                    </div>
                    <div class="icon-wrapper"><span class="iconfont"> </span>每天 8:30 放号</div>
                  </div>
                </div>
            ...
            <div class="">
              <div class="hospital-list-item hos-item" index="0">
                <div class="wrapper">
                  ...
                  <div class="bottom-container">
                    <div class="icon-wrapper"><span class="iconfont"> </span>三级甲等</div>
                    <div class="icon-wrapper"><span class="iconfont"> </span>每天 8:30 放号
                    </div>
                  </div>
                </div>
                <img src="images/23176337663806575.png" alt="北京协和医院" class="hospital-img">
