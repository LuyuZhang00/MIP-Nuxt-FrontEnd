    ...
    <div class="page-container">
      <div class="personal-patient">
        ...
        <div>
          ...
          <div class="sub-title">
            <div class="block"></div>建档信息（完善后部分医院首次就诊不排队建档）
          </div>
          <div class="content-wrapper">
            <el-form :model="patient" label-width="110px" label-position="left" ref="patient" :rules="validateRules">
              ...
              <el-form-item prop="addressSelected" label="当前住址：">
                <el-cascader ref="selectedShow" v-model="patient.addressSelected" class="v-address" :props="props"></el-cascader>
              </el-form-item>
    ...
    return {
      ...
      props: {
        ...
        async lazyLoad(node, resolve) {
          const { level } = node
          //异步获取省市区
          dictApi.findByParentId(level ? node.value : '86').then(
            response => {
